...
class _SignUpScreenState extends ConsumerState<SignUpScreen> {
  ...
  final TextEditingController _nicknameController =
      TextEditingController(); // Nickname controller
  ...
  void _signUp() async {
    if (_formKey.currentState!.validate()) {
      // Ensure you collect the nickname from the user
      String nickName = _nicknameController.text.trim(); // Get nickname
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFormField(
                    controller: _nicknameController, // Nickname field
                    label: "Nickname",
                    hintText: "Enter a nickname",
                    prefixIcon: Icons.account_circle,
                    validator:
                        (val) => val!.isEmpty ? "Nickname required" : null,
                    contentPadding: const EdgeInsets.symmetric(
                      vertical: 22,
                      horizontal: 16,
                    ),
...
//   if (_formKey.currentState!.validate()) {
//     // Ensure you collect the nickname from the user
//     String nickName = _nicknameController.text.trim();  // Add this line for nickName

//     await ref.read(authProvider.notifier).signUp(
//       _emailController.text.trim(),
//       _passwordController.text.trim(),
//       _nameController.text.trim(),  // ✅ pass name here
//       nickName,  // Pass the nickname here
//     );
